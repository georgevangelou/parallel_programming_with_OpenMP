...
Version Notes:
    Compiles/Runs/Debugs with: gcc tsp_rnd06.c -o tsp_rnd06 -lm -fopt-info -O3 -pg -fopenmp && time ./tsp_rnd06 && gprof ./tsp_rnd06
	...
	This is an experimental version where one of the threads becomes responsible for refilling the <RandomSequences> array 
        while the others perform the swappings. No time improvements were achieved though.
*/	
...
// ****************************************************************************************************************
// Initializes the random sequences array 1 ensuring adjucent numbers are never the same
// ****************************************************************************************************************
...
// ****************************************************************************************************************
// Initializes the random sequences array 2 ensuring adjucent numbers are never the same
// ****************************************************************************************************************
...
double SwapCities(double totDist, int repetition) {
	...
	{   
        ...
        if (thisThreadsID==0) {
            //printf("I am the master thread and I am initializing arrays\n");

...
Version Notes:
    Compiles with: gcc kmeans05.c -o kmeans05 -lm -fopt-info-vec-optimized
...
Profiler Output:
    ...
    97.82    45.45    45.45                              estimateClasses
    1.14     45.99     0.53                              SetVec
    1.14     46.52     0.53                              estimateCenters
*/

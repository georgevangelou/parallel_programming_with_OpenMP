...
Version Notes:
    Compiles with: gcc kmeans11.c -o kmeans11 -lm -fopt-info
    Inherits all settings of the previous version unless stated otherwise
    Includes the compiler option "avx" to improve vector processing (SIMD)
    Placed variable declarations deeper within the loops
    Executes the algorithm for 100000 vectors of 1000 dimensions and 100 classes and produces correct results
    Needs ~19 seconds to reach 16 repetitions
...
Profiler Output:
    ...
    95.61     18.52    18.52                             estimateClasses
    2.63     19.03     0.51                             SetVec
    1.81     19.38     0.35                             estimateCenters
